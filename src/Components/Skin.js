...
import '../App.css';
import image1 from '../Assets/Images/Skin_module/fryzjer.jpg';
import image2 from '../Assets/Images/Skin_module/olejek.jpg';

export default function Example() {
  return (
    <div className="bg-white">
      <div className="orange-baner">
        <span className="orange-baner-text">FRYZJERSTWO</span>
      </div>
